...
<option value="Any Other Govt Issued Doc">Any Other Gov't Issued Doc</option>
     </select></div>

    <div class="form-group"> <label for="exampleInputEmail1">Identity/Student Card No.</label> <input type="text" name="icnum" value="" class="form-control" required='true'> </div>
