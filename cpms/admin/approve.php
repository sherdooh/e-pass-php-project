...
<head>
    ...
    <title>Curfew Pass Management System | Approve Pass</title>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <?php
$eid=$_GET['editid'];
$sql="SELECT * from  tblapplypass where ID=$eid";
$query = $dbh -> prepare($sql);
$query->execute();
...
<?php $cnt=$cnt+1;}} ?> 
     <p style="padding-left: 450px"><button type="submit" class="btn btn-primary" name="submit" id="submit">Approve</button></p> </form>
                                </div>
